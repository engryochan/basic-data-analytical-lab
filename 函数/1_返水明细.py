...
# 返水数据
start_date = '2025-08-11 00:00:00'  # 开始时间
end_date = '2025-08-11 00:59:59'    # 结束时间
site_id = '9001'  # 站点ID
...
and status = 2 and category in (999555)
and site_id = {site_id};
"""

daily_promo = pd.read_sql_query(query, engine)
...
daily_promo.to_excel(os.path.join(_out, '返水单号_2.xlsx'), index=False)
