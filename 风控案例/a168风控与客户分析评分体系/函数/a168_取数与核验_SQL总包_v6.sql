/* ╔═══════════════════════════════════════════════════════════════════════════╗
   ...
   ═══ 分析窗口（正名版，务必按此措辞对外）═══════════════════════════════════
     ...
     改窗时须同时全量替换两枚窗口字面量（v5 实测：'2026-03-21' 共 181 处／'2026-08-07' 共 250 处），不得只改其一；
   ...
   ═══ 血统关系登记（2026-08-13 立 · 一族四档）════════════════════════════
     本包为「取数层」，居一族四档之料源位。改本包即改全族之数字，故列明：
       ...
       a168_取数与核验_SQL总包_v6.sql               本包(料源)   一切数字之唯一出处
   ...
   ╚══════════════════════════════════════════════════════════════════════════╝
     ...
     配套三条：
       ...
       ③ 全包现状（2026-08-12 逐行实测；计数口径＝行首以 -- 起首的导出标记行）：
          产出交付件的语句 71 条（新式 49 条 + 卷一旧式块注释 22 条；v5 并入 §P12a/§P12b/§P12c 三条，v6 并入 §P11a~d 四条；§P12b-pre 只看屏幕不计，§P12d 系改窗指引无独立语句），
