/* ╔═══════════════════════════════════════════════════════════════════════════╗
   ║  ⚠⚠ 本档系 v11 之【注释纠错工作件】(comment-hotfix)，非正式版本 ⚠⚠        ║
   ║  ── 2026-08-23 · REDTEAM 裁示所立 ─────────────────────────────────────── ║
   ║  一、正式基线仍为 a168_取数与核验_SQL总包_v11.sql（原档未改、未改名）；     ║
   ║     在 v12 通过六元组、纯代码 MD5、注释剥离比对与全套复检之前，            ║
   ║     v11 仍是最后一个正式、可追溯之基线版本，禁加 _superseded。             ║
   ║  二、本件只改 G-4 与 G-5 两项注释，SQL 主体、字段、输出文件名一字未动；     ║
   ║     其存在之唯一理由，是止住两处「已被实测直接推翻」之错误横幅继续          ║
   ║     充当后续施工依据。                                                     ║
   ║  三、G-1（Δ_old-new 正名）／G-2（判词四态升五态）／G-3（三诊断入册）／      ║
   ║     G-6（CLOSED/OBSERVED 状态登记）一律进入 v12 staging，本件不施工。      ║
   ║  四、本件不得作为正式引用对象；引用请引 v11 原档或将来之 v12。             ║
   ╠═══════════════════════════════════════════════════════════════════════════╣
