...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ★ 2026-08-13 实测结论（读数已到，结论如下）：
     ...
     **`close_bet_time = bet06 + 30秒` 之设想不成立**——单一固定位移必致误判。
     惟窗口既呈清晰双峰而非长尾缓降，则其应为**桌台或房间层之制度属性**，
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   缘起：§Z-09b 实测得窗口呈双峰（约 14 秒与约 26 秒），非单一常量。
         若该二制式**按桌台（bet39）或房间（bet40）划分且各桌恒定**，
